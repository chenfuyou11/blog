using BlogDemo.Infrastructure.Resources.Roles;
    ...
    public class RoleController : Controller
    {
      ...
      //  private readonly IHtmlLocalizer<AdminController> TH;
        ...
        public RoleController(
            ...
            //ISession session,
            IStringLocalizer<RoleController> stringLocalizer,
        ...
        public async Task<IActionResult> Create(CreateRoleViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, T["角色已经存在"]);
                }
            }
        ...
        //    var role = (ApplicationRole)await _roleManager.FindByNameAsync(_roleManager.NormalizeKey(id));
        //    if (role == null)
        //    {
        //        return NotFound();
        //    }
